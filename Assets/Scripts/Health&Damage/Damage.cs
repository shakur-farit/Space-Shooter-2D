...
public class Damage : MonoBehaviour
{
    ...
    [Tooltip("Whether or not to destroy the attached game object after clash with Player")]
    public bool destroyAfterDamage = true;
    [Tooltip("Whether or not to destroy the attached game object after dealing damage")]
    public bool destroyAfterOnTriggerEnterWithPlayer = true;
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if(destroyAfterOnTriggerEnterWithPlayer && collision.gameObject.tag == "Player")
        {
            DealDamage(collision.gameObject);
